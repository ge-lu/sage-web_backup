  ...
  return (
    <div className="w-full h-full bg-[#F5F7F9] px-6 pt-12 pb-32">
      ...
      <div className="flex flex-col items-center mb-10">
        ...
        <div className="px-4 py-1.5 bg-[#FDF6E3] text-[#3A6F5B] text-sm font-bold rounded-full mt-2">Aura Premium</div>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="aura-card divide-y divide-gray-100 overflow-hidden rounded-xl border border-gray-200">
            <div className="p-5 flex items-center justify-between bg-white active:bg-gray-50 transition-colors">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[#F5F9FF] flex items-center justify-center text-guardian-blue"><Icons.Mic className="w-7 h-7" /></div>
                <div>
            ...
            <div className="p-5 flex items-center justify-between bg-white active:bg-gray-50 transition-colors">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[#F5F9FF] flex items-center justify-center text-guardian-blue"><Icons.Camera className="w-7 h-7" /></div>
                <div>
        ...
        <div>
          ...
          <div className="aura-card divide-y divide-gray-100 overflow-hidden rounded-xl border border-gray-200">
            <div className="p-5 flex items-center justify-between bg-white active:bg-gray-50 transition-colors">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[#F5F9FF] flex items-center justify-center text-guardian-blue"><Icons.Shield className="w-7 h-7" /></div>
                <div>
                  <p className="text-xl font-bold text-gray-900">Fraud Protection</p>
                  <p className="text-sm text-guardian-blue font-bold mt-0.5">Active & Monitoring</p>
                </div>
              </div>
              <Icons.ChevronLeft className="w-7 h-7 text-gray-400 rotate-180" />
            </div>
        ...
        <button className="w-full h-16 rounded-2xl border-2 border-[#5B84B5] text-[#5B84B5] font-bold text-xl flex items-center justify-center gap-3 active:scale-95 transition-transform bg-white shadow-sm">
